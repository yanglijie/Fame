...
let Defined_appl_24 = ["布防","撒防"]


let device_type = ["null","null","路由器中控","USB中控","null","null","null","1键开关","2键开关","3键开关","窗帘开关","浴霸开关","浴霸","控制插座","能耗插座","幕布","投影仪","电视机","音响 ","空调","机顶盒","DVD","其他红外电器设备","门磁传感器","运动感应","燃气传感器","烟雾传感器","温湿度传感","漏水传感","摄像头","情景模式面板","智能门锁","空气传感器","中央空调","双速新风机"]
